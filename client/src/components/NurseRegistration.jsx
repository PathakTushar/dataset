// components/NurseRegistration.js
...
const NurseRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios.post("http://localhost:8000/nurses/register", formData)
    if(res.status === 200){
      setFormData({
        name: '',
        email: '',
  ...
  return (
    <div className="max-w-md mx-auto my-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Add more input fields for other nurse information */}
        <div>
